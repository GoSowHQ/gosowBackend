...
async function main() {
  ...
  const neuralDb = await prisma.project.upsert({
    ...
    create: {
      ...
      description:
        'NeuralDB is an AI-powered database that writes its own queries. Simply describe what data you need in plain English, and NeuralDB translates it into optimized SQL. Built on top of PostgreSQL, it integrates seamlessly with your existing stack.\n\nKey Features:\n- Natural language to SQL translation\n- Automatic query optimization\n- Real-time performance monitoring\n- Compatible with all major ORMs\n- Self-healing indexes\n\nWe are building the future of how developers interact with databases. No more writing complex joins or debugging slow queries — just describe what you need.',
  ...
  const openmetrics = await prisma.project.upsert({
    ...
    create: {
      ...
      description:
        'OpenMetrics is a fully open-source analytics platform for modern SaaS products. Self-host your analytics and own your data.\n\nTired of paying $500/month for analytics? OpenMetrics gives you:\n- Real-time dashboards\n- Funnel analysis\n- Cohort tracking\n- A/B testing built-in\n- Privacy-first (GDPR compliant)\n- One-click deploy to Vercel/Railway',
  ...
  const pixelforge = await prisma.project.upsert({
    ...
    create: {
      ...
      description:
        'PixelForge is a real-time collaborative design tool built for modern teams. Think Figma meets VS Code — with built-in design tokens, component libraries, and code export.\n\nDesign, prototype, and hand off — all in one tool.',
  ...
  const chainguard = await prisma.project.upsert({
    ...
    create: {
      ...
      description:
        'ChainGuard is a smart contract security auditing platform. Upload your Solidity contracts and get instant vulnerability reports with fix suggestions.\n\nProtect your users and your reputation with automated security audits.',
  ...
  const tinyml = await prisma.project.upsert({
    ...
    create: {
      ...
      slug: 'tinyml-kit',
      description:
        'TinyML Kit makes machine learning on microcontrollers accessible to everyone. Our hardware kit + SDK lets you deploy ML models to Arduino and ESP32 in minutes.\n\nPerfect for IoT, robotics, and edge computing projects.',
  ...
  await prisma.event.upsert({
    ...
    create: {
      ...
      description:
        'Join 500+ developers for a 48-hour AI hackathon. Build innovative AI applications, compete for $50K in prizes, and network with industry leaders.\n\nTracks:\n- LLM Applications\n- Computer Vision\n- AI for Healthcare\n- Open Track\n\nSponsored by top AI companies. Meals and swag included.',
      type: 'HACKATHON',
      status: 'UPCOMING',
  ...
  await prisma.event.upsert({
    ...
    create: {
      ...
      description:
        'A virtual conference celebrating open source innovation. Hear from maintainers of the world\'s most popular projects, learn about sustainability, and discover new tools.\n\n20+ speakers. Free to attend.',
      type: 'WEBINAR',
      status: 'UPCOMING',
      isVirtual: true,
  ...
  await prisma.event.upsert({
    ...
    create: {
      ...
      description:
        'Indie developers showcase their products to investors, press, and the community. 10 selected projects get 5 minutes on stage.\n\nNetwork with fellow indie hackers and potential investors.',
      type: 'DEMO_DAY',
      status: 'UPCOMING',
